...
if __name__ == "__main__":
    ...
    plt.plot(t_seg_1, rms_seg_1, "b-")
    plt.plot(t_seg_2, rms_seg_2, "r-", label="dislocation segment 2, RMS = 110.568")
    plt.plot(t_seg_3, rms_seg_3, "g-", label="dislocation segment 3, RMS = 240.414")
    plt.plot(t_seg_4, rms_seg_4, "y-", label="dislocation segment 4, RMS = 277.3147")
